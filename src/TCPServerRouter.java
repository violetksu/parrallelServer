...
public class TCPServerRouter {
    public static void main(String[] args) throws IOException {
        ...
        Object [][] RoutingTable = new Object [10][2]; // routing table row is index,
        // columns hold the socket IP address and socket info
        ...
        System.out.println("Closing ServerRouter");
